import ReceivableCardCompany from "@/components/Receivables/ReceivableCardCompany";
          ...
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredCompanies.map((company) =>
                company.accountsReceivable.map((receivable) => (
                  <ReceivableCardCompany
                    key={receivable.id}
            ...
            {filteredCompanies.every(
              (company) => company.accountsReceivable.length === 0
            ) && (
